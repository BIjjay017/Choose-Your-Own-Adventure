...
def create_story(
    ...
    # Run story generation in background
    background_tasks.add_task(generate_story_task, job_id=job.job_id,theme=request.theme, session_id=session_id)
...
def generate_story_task(job_id: str, theme: str, session_id: str):
    ...
    try:
        ...
        try:
            ...
            db.commit()
            print(f"Story generated successfully for job {job_id}")
            ...
            job.error = str(e)
            db.commit()
            print(f"Story generation failed for job {job_id}: {e}")
